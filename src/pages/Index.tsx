...
const Index = () => {
  ...
  const getModelDescription = (format: string) => {
    const descriptions = {
      openbar: "Фиксированная стоимость за гостя. Вы знаете точную сумму заранее",
      minimal: "Гарантированная минимальная сумма + доплата по факту потребления ваших гостей",
      revenue: "Деление выручки между нами и вами. Подходит для фестивалей и больших мероприятий",
      fixfee: "Вы покупаете алкоголь сами, мы предоставляем барменов и оборудование",
      hookah: "Кальянная зона как дополнение к основному бару на вашем мероприятии"
    };
      ...
      <section className="py-20 bg-premium-gray">
        <div className="container mx-auto px-2 sm:px-4 w-full max-w-full">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: "Корпоратив сети ресторанов", guests: "300 гостей", details: "3 линии бара, 5 часов", result: "средний чек 2,450 ₽/гость", revenue: "735,000 ₽" },
